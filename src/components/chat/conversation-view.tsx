    ...
    <div className={`flex ${mine ? "justify-end" : "justify-start"}`}>
      <div className={`flex max-w-[85%] flex-col gap-1 sm:max-w-[78%] ${mine ? "items-end" : "items-start"}`}>
        ...
        >
          ...
          {!removed && (
            <div className={`mt-2 flex items-center gap-1 rounded-full border bg-background px-1 py-0.5 shadow-sm transition-opacity focus-within:opacity-100 sm:absolute sm:-top-3 sm:right-1 sm:mt-0 sm:opacity-0 sm:group-hover:opacity-100 ${mine ? "justify-end" : ""}`}>
