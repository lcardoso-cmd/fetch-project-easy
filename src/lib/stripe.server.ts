...
/** Cliente Stripe roteado pelo gateway (as chaves locais são identificadores de conexão). */
...
/**
 * Verifica a assinatura HMAC do webhook sem depender do SDK.
 * Rejeita corpo sem assinatura, formato inválido e timestamp antigo.
 */
