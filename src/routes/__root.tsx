...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "JurisMind AI — transforme cada caso em um agente de IA que trabalha para você" },
      ...
      { property: "og:title", content: "JurisMind AI — transforme cada caso em um agente de IA que trabalha para você" },
      ...
      { name: "twitter:title", content: "JurisMind AI — transforme cada caso em um agente de IA que trabalha para você" },
